...
public class SearchFragmentTabListener<T extends Fragment> implements TabListener {
	...
	public SearchFragmentTabListener(FragmentActivity activity, String tag, Class<T> clz) {
		mActivity = activity;
		mTag = tag;
		mClass = clz;
	...
	public SearchFragmentTabListener(int fragmentContainerId, FragmentActivity activity, 
